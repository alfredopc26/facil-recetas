  ...
  <ion-page >
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom">
        ...
        <ion-tab-button tab="tab3" href="/tabs/add">
          <ion-icon aria-hidden="true" :icon="addCircleSharp" />
          <ion-label>Add Recette</ion-label>
        </ion-tab-button>
...
import { ellipse, square, triangle, gridOutline, homeOutline, addCircleSharp, moon } from 'ionicons/icons';
</script>
